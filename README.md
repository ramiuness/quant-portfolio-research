...
### 4. Measuring Asset Risk Premium
**Status**: Research Complete (January 2025) | Backtesting Pending

Machine learning approach to measuring asset risk premium using 147 quantitative characteristics and SEC filing text features. Originated from the McGill-FIAM Asset Management Hackathon 2025.
...
→ [Project README](measuring-asset-risk-premium/README.md) | [Executive Summary](measuring-asset-risk-premium/docs/EXECUTIVE_SUMMARY.md)
...
- **Limited holdout validation**: Primarily rolling window CV; measuring-asset-risk-premium lacks full backtest
...
├── measuring-asset-risk-premium/               # ML factor models (Hackathon 2025)
